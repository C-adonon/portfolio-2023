...
<template>
    <nav id="navbar">
        ...
        <div id="all-links" class="links-container">
...
nav#navbar {
    ...
    align-items: center;
    height: 80px;
    border-bottom: 2px solid v.$neutral-900;
...
@media (max-width: 900px) {
    nav#navbar {
        ...
        div.contact {
            ...
            border-width: 2px;
            border-style: solid;
            border-image: linear-gradient(to right, v.$primary-050 , v.$primary-700) 1;
